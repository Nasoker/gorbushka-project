...
const createLogicForChangeModal = (id, fetch) => {
    ...
    getCookieValue("role") === "Moderator" && changeOperationModalInputs.forEach((elem) => elem.remove())
    ...
    changeOperationOpenModal.forEach((elem, i) => {
        elem.addEventListener("click", () => {
            ...
            if (getCookieValue("role") === "Moderator" && lineElems[5].children[0].textContent === "Просмотреть") {
            ...
            } else if (getCookieValue("role") !== "Moderator") {
    ...
    changeOperationModalBtns.forEach((elem, i) => {
        elem.addEventListener("click", () => {
            if (i === 2) {
                if (getCookieValue("role") === "Moderator") {
